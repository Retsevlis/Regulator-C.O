...
//*************************************************************************************************************************
volatile const double Kdo = 1.3;      // |1.45| współczynnik domu - zależne od parametrów cieplnych budynku (0.8 do 1.5)
...
//      Stałe     ................................................................................................................
volatile const int dTpod = 15;                         // |15| graniczna odchyłka temperatury pokojowej  w dół, poniżej której nastąpi wymuszono korekta o Tkopo
volatile const int dTpog = 7;                          // |7| graniczna odchyłka temperatury pokojowej  w górę, powyżej której nastąpi wymuszone korekta o -Tkopo
volatile const int Tkopo = 40;                         // |40| wielkość korekty temperatury po przekroczeniu granicznej temperatury pokojowej w dół, lub w górę -2 stopnie
...
void loop()
{
  ...
  */
  ...
  if ( Fco == 0 && (dTpow > dTpowmin + 10) && digitalRead (PUMP_pin) == LOW) { // piec grzeje to załącz pompę - dla pieca
    digitalWrite (PUMP_pin, HIGH);
  }
  ...
  if (m == 200) {       //po dwóch sekundach
    ...
    if (n == 5) {       // po 10-ciu sekundach
      ...
      if (o == 6) {    // po 1 minucie
        ...
        if (((Tpozad - Tpo ) <= 5 ) && ((Tpo - Tpozad  ) <= 0 )) { // jezeli w granicach -0,5 do 0 to wyłącz korektę
          Tpopo = 0;
        }
    ...
    Setpoint = (Tpozad + Tpopo - Tot) * Kdo + Tpozad + Tpopo + Tko; // obliczenie temperatury zadanej(Setpoint)
